...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kestraltorah@163.com/KTDirectSeedingSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kestraltorah@163.com' => 'guowei@huami.com' }
  s.source           = { :git => 'https://github.com/kestraltorah@163.com/KTDirectSeedingSDK.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'KTDirectSeedingSDK' => ['KTDirectSeedingSDK/Assets/*.png']
  # }
